...
function stage1(){
  ...
  if (n0 >= 0 && n0 < 5){
    ...
    if (n0 == 0) {
      fill(220, 80, 80);
      textSize(20);
      text("> enter로 대화 넘기기", width/2, 3*height/4 + height/27, 800);
  }
  }
  if (n0 >= 1 && n0 <= 4) {
  ...
  if (n0 >= 5) {
    ...
    scale(-1, 1);
    image(cam, ran1, ran2, width/2.5, height/2.5);
    pop();
...
function stage2(){
  ...
  if(n1 >= 0) {
    ...
    if (n1 % 2 == 1){
      textAlign(CENTER);
      textSize(3);
      text(muyahoImage, width/2, 3*height/4 - cam.height - 3*height/18);
      if (n1 == 9) {
        textAlign(LEFT);
        textSize(20);
        fill('red');
        text("power(): 힘", width/2, 3*height/4 + height/27, 800);
        fill('green');
        text("speed(): 속도", width/2 + width/12, 3*height/4 + height/27, 800);
        fill('blue');
        text("shootRate(): 발사속도", width/2+ width/6, 3*height/4 + height/27, 800);
        fill('pink');
        text("shootMode(): 발사모드", width/2 + width/1920*560, 3*height/4 + height/27, 800);
      }
    } else if (n1 >= 6) {
      webcam1(50, 1, 3*height/4 - cam.height - height/9, 12);
    }
  } 
}
...
function stage4(){
  ...
  if (n2 % 2 == 1){
    ...
    webcam1(150, 2, height/2 - cam.height/3 - height/20, 4)
  }
}
...
function box1Small(d, n){
  ...
  fill(0, 255, 65)
  textSize(30);
  text("-------------------------\n|                        |\n|                        |\n|                        |\n|                        |\n|                        |\n|                        |\n|                        |\n|                        |\n-------------------------", width/2, height/3 - height/36);
  textSize(16);
  text(d[n], width/2, height*0.58, width/2)
}
